...
def DETR2COCO(srcpath, destfile):
    ...
    info = {'contributor': 'captain group',
           'data_created': '2018',
           'description': 'This is 1.0 version of DETR dataset.',
           'url': 'http://captain.whu.edu.cn/DETRweb/',
           'version': '1.0',
           'year': 2018}
    data_dict['info'] = info
    data_dict['images'] = []
    ...
    with open(destfile, 'w') as f_out:
        ...
        for file in filenames:
            ...
            # annotations
            objects = util.parse_detr_poly2(file)
            for obj in objects:
                single_obj = {}
...
if __name__ == '__main__':
    DETR2COCO(r'/data0/data_dj/1024_new', r'/data0/data_dj/1024_new/DETR_trainval1024.json')
