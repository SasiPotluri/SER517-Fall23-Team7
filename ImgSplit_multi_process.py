...
import numpy as np
import math
from detr_utils import GetFileFromThisRootDir
import cv2
import shapely.geometry as shgeo
import detr_utils as util
import copy
...
class splitbase():
    def __init__(self,
        ...
        """
        :param basepath: base path for detr data
        :param outpath: output base path for detr data,
    ...
    def SplitSingle(self, name, rate, extent):
        ...
        objects = util.parse_detr_poly2(fullname)
        for obj in objects:
...
if __name__ == '__main__':
    ...
    split = splitbase(r'/home/niihalsinghh/data/detr/val',
                       r'/home/niihalsinghh/data/detr/valsplit',
                      gap=200,
                      subsize=1024,
                      num_process=8
                      )
